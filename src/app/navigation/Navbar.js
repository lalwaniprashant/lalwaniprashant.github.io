      ...
      <div className="container">
        ...
        >
          ...
          <div className={`${styles.menuBox3}`}>
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=prashantlalwani55232@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
              <button type="button" className="btn btn-primary" name="hireme">
                <GmailIcon size={16} /> Hire Me
              </button>
            </a>
          </div>
        </nav>
