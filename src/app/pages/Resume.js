...
const Resume = () => {
    ...
    return (
        <div>
            <div>
                <Title title={"About"} />
                <p className='text-wrap txt-indent'>My name is Prashant Lalwani. I am currently pursuing Bachelor of Technology (B.Tech) in Electronics and Communication
                    Engineering at Sardar Vallabhbhai National Institute of Technology Surat (SVNIT). Currently, I am a final year student.
                </p>
